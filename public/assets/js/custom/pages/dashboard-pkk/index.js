...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (modalEditDataEl) {
        modalEditDataEl.addEventListener('show.bs.modal', function (event) {
            ...
            document.getElementById('modalEditDataSubtitle').textContent = namaItem;
        });
    }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const modalEditPesertaEl = document.getElementById('kt_modal_edit_data_peserta');
    if (modalEditPesertaEl) {
        modalEditPesertaEl.addEventListener('show.bs.modal', function (event) {
            const trigger = event.relatedTarget;
            const namaItem = trigger.getAttribute('data-nama-item') || '';
            document.getElementById('modalEditDataPesertaSubtitle').textContent = namaItem;
        });
    }
});